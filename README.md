...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:7C3AED,50:9D4EDD,100:C084FC&height=135&section=header&text=Krishna%20Koushik%20Unnam&fontSize=42&fontColor=ffffff&animation=fadeIn&fontAlignY=39&desc=AI%2FML%20Engineer%20%C2%B7%20Generative%20AI%20%C2%B7%20MLOps%20%C2%B7%20Distributed%20Systems&descAlignY=62&descSize=16&descColor=E9D5FF" />

<!-- Typing animation -->

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code\&weight=700\&size=20\&duration=3000\&pause=800\&color=9D4EDD\&center=true\&vCenter=true\&width=820\&lines=Building+production-ready+AI+systems+at+scale.;Foundation+Models+%7C+Multimodal+LLMs+%7C+RLHF+%7C+RAG;PyTorch+%7C+CUDA+%7C+vLLM+%7C+TensorRT-LLM+%7C+Kubernetes;Distributed+Training+%7C+MLOps+%7C+Agentic+AI+%7C+Cloud)](https://git.io/typing-svg)

<br/>

<img src="https://media.giphy.com/media/qgQUggAC3Pfv687qPC/giphy.gif" width="340" alt="AI and software engineering" />
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-0A66C2?style=for-the-badge\&logo=linkedin\&logoColor=white)]([https://linkedin.com/in/krishna-koushik-unnam-a952741b5](https://www.linkedin.com/in/krishna-u-a40846423/))
...
[![Skills](https://skillicons.dev/icons?i=python,java,cpp,pytorch,tensorflow,fastapi,spring,postgres,mysql,kafka,docker,kubernetes,aws,azure,gcp,git,githubactions,linux,bash,vscode,idea,postman\&theme=dark\&perline=11)](https://skillicons.dev)
